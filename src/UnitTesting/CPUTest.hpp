...
constexpr uint16_t UNUSABLE_AREA = 0xFEA0;
constexpr uint16_t IO_REGISTERS = 0xFF00;
constexpr uint16_t HRAM_LOC = 0xFF80;
...
class CPUTest
{
    ...
    private:
        ...
        std::vector<uint8_t> workRAMBanks;
        
        uint8_t curROMBank;
        uint8_t curRAMBank;
        uint8_t curworkRAMBank;
    ...
    private:
        ...
        // Banking functions
        void getBankMode(const uint8_t type);
